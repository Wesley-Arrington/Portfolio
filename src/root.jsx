    ...
    render() {
        return (
            <div>
                ...
                <Project linkType="Live Link" linkName="https://gogo-heroku-clone.herokuapp.com/#/" title={"GoGo"} imageUrl={"gogo.png"} description={"Description: A site which mimics Indiegogo in style and functionality. Has the ability to create campaigns and contribute to those campaigns."} technologies={"Technologies: React, Redux, Ruby, Rails 5, Ajax, CSS, Javascript"}/>
                <Project linkType="Live Link" linkName="http://multi-go.herokuapp.com/#/" title={"Multi-Go"} imageUrl={"multigo.png"} description={"Description: Go is a classic board game typically played with two players. We made an online go game where play go variations online."} technologies={"Technologies: React, Redux, MongoDB, Express, Javascript, Node"}/>
